        ...
        <main style={{ paddingTop: 20 }}>
          <Container>
            ...
            <Row>
              <Col>
                <p>
                  Shows the overall health state of machine.The red line is
                  threshold of good health the blue line shows the current
            ...
            >
              <LineChart
                ...
                data={
                  machineConditionData
                    ? machineConditionData
                    : [{ label: "wait", value: 1, threshold: 3.9 }]
                }
                title="Energy"
                color="#2F4B8A"
                max={10}
            ...
            <Row>
              <Col>
                <p>
                  Anomaly detector represent actuators, sensors and motor
                  performance it takes a last reading monitors if there is any
                  abnormal activity and triggers it as alarm.
                </p>
              </Col>
            </Row>
            <br />
